...
public class MasterMindGame extends Games {
		...
		do {
			...
			do {
				...
				do {
					tryNber++;
					// User guess
					logger.info("Propositon de combinaison");
	...
	public void duel() {
		...
		do {
			...
			logger.info("Affichage du code secret du joueur");
			...
			do {
				...
				// Computer guess
				logger.info("Proposition de combinaison de l'ordinateur");
				System.out.println("Proposition de l'ordinateur : " + Arrays.toString(possibleCombi.get(0)));
				...
				// Computer secret code found - Test
				if (secretCodeComputer == userInput) {
					logger.info("Code secret de l'ordinateur trouvé");
					System.out.println("Vous avez trouvé le code secret " + secretCodeComputer + "!");
					break;
				}
				if (tryNber >= tryMax) {
					logger.info("Code secret de l'ordinateur non trouvé");
	...
	private void gamePresentation(int n, int m, int maxTry) {
		logger.info("Message de présentation du jeu");
	 ...
	 * 
	 */
	private void putCombinaison(int[] combination, int n, int m) {
		for (int i = 0; i < n; i++) {
	 ...
	 * @return
	 */
	private String compareTab(int[] inputTab, int[] tabSecretCode) {
		int wellPlaced = 0;
		int badPlaced = 0;
	 ...
	 * @return
	 */
	private List<List<Integer>> extractPair(List<Integer> lst) {
	 ...
	 * @return
	 */
	private List<List<Integer>> extractTrio(List<Integer> lst) {
		List<List<Integer>> val = new ArrayList<>();
	 ...
	 * @return
	 */
	private List<List<Integer>> extractQuatuor(List<Integer> lst) {
		List<List<Integer>> val = new ArrayList<>();
	...
	private List<List<Integer>> extract5(List<Integer> lst) {
		List<List<Integer>> val = new ArrayList<>();
	...
	private List<List<Integer>> extract6(List<Integer> lst) {
		List<List<Integer>> val = new ArrayList<>();
	...
	private List<List<Integer>> extract7(List<Integer> lst) {
		List<List<Integer>> val = new ArrayList<>();
	...
	private List<List<Integer>> extract8(List<Integer> lst) {
		List<List<Integer>> val = new ArrayList<>();
	...
	private List<List<Integer>> extract9(List<Integer> lst) {
		List<List<Integer>> val = new ArrayList<>();
